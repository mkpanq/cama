...
import BankDefaultIcon from "@/images/bankDefault.png";
  ...
  return (
    <li className="relative flex justify-between py-5 border-b border-gray-200 px-3">
      <div className="flex gap-x-4 pr-6 sm:w-1/2 sm:flex-none">
        <Image
          src={connection.institutionLogo ?? BankDefaultIcon}
        ...
        <div className="min-w-0 flex-auto">
          ...
          <p className="mt-1 flex text-xs/5 text-gray-500">
            {connection.agreement.institutionId}
          </p>
        </div>
      </div>
        ...
        <div className="hidden sm:block">
          <p className="text-sm/6 text-gray-900">
            ...
            <span className="font-black">
              {connection.agreement.expirationDate.toDateString()}
            </span>
          </p>
